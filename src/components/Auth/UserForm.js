   ...
   return (
    <Container style={{marginTop:'8rem'}}>
        ...
        <div className='d-flex w-50 shadow-lg rounded mx-auto'>
          <img src={require('../../resources/userFormBg.jpg')} className="w-50"/>
          <Form className='w-50 mx-auto p-3 my-1 text-success' onSubmit={submitHandler}>
              <h3 className='mx-auto my-2 mb-3 w-50 border-bottom border-success text-center'>Signup</h3>
              ...
              <div className='my-2 w-100 text-center'>
                  <Button type='submit' variant='success' size='md'>Create Account</Button>
              </div>
              <div className='my-2 w-100 text-center'>
                  <Button size='sm' variant='outline-success'>Login with existing account</Button>
              </div>
          </Form>
        </div>
    </Container>
